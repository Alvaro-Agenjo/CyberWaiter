...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        # E. Lanzar Nodo de Navegación (C++)
        Node(
            package='cyberwaiter_control',
            executable='navigator',
            name='navigator',
            output='screen'
        ),

        # F. Lanzar Solucionador Cinemático (C++)
        Node(
            package='cyberwaiter_control',
            executable='kin_solver',
            name='kinematic_controler',
            output='screen'
        ),

        # G. Lanzar Actuador del Gripper (C++)
        Node(
            package='cyberwaiter_control',
            executable='gripper',
